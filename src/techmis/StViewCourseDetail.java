 ...
 * @author shan
 */
public class StViewCourseDetail extends javax.swing.JFrame {

    /**
     * Creates new form StViewCourseDetail
     */
    public StViewCourseDetail() {
        initComponents();
        showUser();
    }
    ...
    private void BackButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BackButtonActionPerformed
        WelcomeStudent co = new WelcomeStudent();  // back
        co.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StViewCourseDetail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StViewCourseDetail().setVisible(true);
            }
        });
    }
